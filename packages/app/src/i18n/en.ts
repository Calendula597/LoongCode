export const dict = {
  ...
  "command.skill.marketplace": "Skill Marketplace",
  ...
  "settings.skills.tab.repos": "Repositories",
  ...
  "settings.skills.mine": "Mine",
  "settings.skills.searchPlaceholder": "Search skills...",
  "settings.skills.searchAria": "Search skills",
  "settings.skills.loading": "Loading skills...",
  "settings.skills.empty": "No skills found.",
  "settings.skills.noInstalled": "No skills installed.",
  "settings.skills.addRepo": "Add",
  "settings.skills.addingRepo": "Adding...",
  "settings.skills.repoPlaceholder": "https://gitee.com/owner/repo",
  "settings.skills.repoAria": "Add GitHub repo",
  "settings.skills.noRepos": "No GitHub repos configured.",
  "settings.skills.error.install": "Failed to install \"{name}\"",
  "settings.skills.error.uninstall": "Failed to uninstall \"{name}\"",
  "settings.skills.error.addRepo": "Failed to add repo",
  "settings.skills.removeRepo": "Remove {name}",
  "settings.skills.skillhub.pinnedName": "Longgang Data Skill Hub",
  "settings.skills.skillhub.configured": "Connected",
  "settings.skills.skillhub.notConfigured": "API key not configured",
  "settings.skills.skillhub.enabled": "Enabled",
  "settings.skills.skillhub.configure": "Configure API key",
  "settings.skills.skillhub.disconnect": "Disconnect",
  "settings.skills.skillhub.dialog.title": "Skill Hub API key",
  "settings.skills.skillhub.dialog.description": "Enter your Skill Hub API key to access private skills. Public skills work without a key.",
  "settings.skills.skillhub.dialog.label": "API key",
  "settings.skills.skillhub.dialog.placeholder": "sk_...",
  "settings.skills.skillhub.dialog.save": "Save",
  "settings.skills.skillhub.dialog.cancel": "Cancel",
  "settings.skills.skillhub.dialog.required": "Please enter an API key",
  "settings.skills.skillhub.dialog.invalid": "Skill Hub rejected this API key",
  "settings.skills.skillhub.dialog.error": "Failed to save API key",
  ...
  "settings.tdai.title": "TDAI (Beta)",
  "settings.tdai.description": "Configure TDAI MemoryProxy identities. Each identity shares the same connection but sends its own request headers.",
  "settings.tdai.section.connection": "Connection",
  "settings.tdai.url.title": "Base URL",
  "settings.tdai.url.description": "TDAI MemoryProxy endpoint shared by every identity.",
  "settings.tdai.url.placeholder": "https://tdai.example.com/v1",
  "settings.tdai.apiKey.title": "API key",
  "settings.tdai.apiKey.description": "API key used to authenticate with the MemoryProxy.",
  "settings.tdai.apiKey.placeholder": "sk-...",
  "settings.tdai.models.title": "Models",
  "settings.tdai.models.description": "Model IDs exposed by every identity. Add or remove rows as needed.",
  "settings.tdai.model.placeholder": "model-id",
  "settings.tdai.model.add": "Add model",
  ...
  // SSH Deploy
  "ssh.deploy.title": "Add SSH Server",
  "ssh.deploy.host": "Host",
  "ssh.deploy.port": "Port",
  "ssh.deploy.username": "Username",
  "ssh.deploy.password": "Password",
  "ssh.deploy.usernamePlaceholder": "root",
  "ssh.deploy.passwordPlaceholder": "Optional",
  "ssh.deploy.output": "Terminal Output",
  "ssh.deploy.connectAndDeploy": "Connect & Deploy",
  "ssh.deploy.deploying": "Deploying...",
  "ssh.deploy.connecting": "Connecting to server...",
  "ssh.deploy.connected": "Connected successfully",
  "ssh.deploy.connectedTo": "Connected to",
  "ssh.deploy.complete": "Deployment complete!",
  "ssh.deploy.terminalReady": "Ready to connect. Click 'Connect & Deploy' to start.",
  "ssh.deploy.step.detectingOS": "Detecting operating system...",
  "ssh.deploy.step.installingNodejs": "Installing Node.js...",
  "ssh.deploy.step.installingLoongcode": "Installing LoongCode...",
  "ssh.deploy.step.installingAgentmemory": "Installing agentmemory...",
  "ssh.deploy.step.startingServe": "Starting LoongCode serve...",
  "ssh.deploy.button.add": "Add SSH Server",

  // Desktop app menu
  "desktopMenu.app.checkForUpdates": "Check for Updates...",
  "desktopMenu.app.settings": "Settings",
  "desktopMenu.app.reloadWebview": "Reload Webview",
  "desktopMenu.app.restart": "Restart",
  "desktopMenu.app.exportLogs": "Export Logs...",
  "desktopMenu.file": "File",
  "desktopMenu.file.newSession": "New Session",
  "desktopMenu.file.openProject": "Open Project...",
  "desktopMenu.file.settings": "Settings",
  "desktopMenu.file.newWindow": "New Window",
  "desktopMenu.file.closeWindow": "Close Window",
  "desktopMenu.edit": "Edit",
  "desktopMenu.edit.undo": "Undo",
  "desktopMenu.edit.redo": "Redo",
  "desktopMenu.edit.cut": "Cut",
  "desktopMenu.edit.copy": "Copy",
  "desktopMenu.edit.paste": "Paste",
  "desktopMenu.edit.delete": "Delete",
  "desktopMenu.edit.selectAll": "Select All",
  "desktopMenu.view": "View",
  "desktopMenu.view.toggleSidebar": "Toggle Sidebar",
  "desktopMenu.view.toggleTerminal": "Toggle Terminal",
  "desktopMenu.view.toggleFileTree": "Toggle File Tree",
  "desktopMenu.view.reload": "Reload",
  "desktopMenu.view.toggleDevTools": "Toggle Developer Tools",
  "desktopMenu.view.actualSize": "Actual Size",
  "desktopMenu.view.zoomIn": "Zoom In",
  "desktopMenu.view.zoomOut": "Zoom Out",
  "desktopMenu.view.toggleFullScreen": "Toggle Full Screen",
  "desktopMenu.go": "Go",
  "desktopMenu.go.back": "Back",
  "desktopMenu.go.forward": "Forward",
  "desktopMenu.go.previousSession": "Previous Session",
  "desktopMenu.go.nextSession": "Next Session",
  "desktopMenu.go.previousProject": "Previous Project",
  "desktopMenu.go.nextProject": "Next Project",
  "desktopMenu.window": "Window",
  "desktopMenu.window.minimize": "Minimize",
  "desktopMenu.window.maximize": "Maximize",
  "desktopMenu.window.closeWindow": "Close Window",
  "desktopMenu.help": "Help",
  "desktopMenu.help.documentation": "Loongcode Documentation",
  "desktopMenu.help.supportForum": "Support Forum",
  "desktopMenu.help.exportLogs": "Export Logs...",
  "desktopMenu.help.shareFeedback": "Share Feedback",
  "desktopMenu.help.reportBug": "Report a Bug",
}
