export const dict = {
  ...
  "command.skill.marketplace": "スキルマーケットプレイス",
  ...
  "settings.skills.tab.marketplace": "マーケット",

  "settings.skills.tab.installed": "インストール済み",

  "settings.skills.tab.repos": "スキルリポジトリ",
  ...
  "settings.skills.skillhub.enabled": "有効",
