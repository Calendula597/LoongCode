export const dict = {
  ...
  "command.skill.marketplace": "Маркетплейс скілів",
  ...
  "settings.skills.tab.installed": "Встановлені",

  "settings.skills.tab.repos": "Репозиторії навичок",
  ...
  "settings.skills.skillhub.enabled": "Увімкнено",
