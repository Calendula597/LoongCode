export const dict = {
  ...
  "command.skill.marketplace": "스킬 마켓플레이스",
  ...
  "settings.skills.tab.marketplace": "마켓",

  "settings.skills.tab.installed": "설치됨",

  "settings.skills.tab.repos": "스킬 저장소",
  ...
  "settings.skills.skillhub.enabled": "활성화됨",
