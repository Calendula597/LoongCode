...
export const dict = {
  ...
  "command.skill.marketplace": "Skill-markedsplass",
  ...
  "settings.skills.tab.installed": "Installert",

  "settings.skills.tab.repos": "Ferdighetslagre",
  ...
  "settings.skills.skillhub.enabled": "Aktivert",
