...
export const dict = {
  ...
  "settings.tdai.description": "配置 TDAI MemoryProxy 身份。每个身份共享同一连接，但发送各自独立的请求头。",
  "settings.tdai.section.connection": "连接",
  "settings.tdai.url.title": "基础 URL",
  "settings.tdai.url.description": "所有身份共享的 TDAI MemoryProxy 端点。",
  "settings.tdai.url.placeholder": "https://tdai.example.com/v1",
  "settings.tdai.apiKey.title": "API 密钥",
  "settings.tdai.apiKey.description": "用于向 MemoryProxy 认证的 API 密钥。",
  "settings.tdai.apiKey.placeholder": "sk-...",
  "settings.tdai.models.title": "模型",
  "settings.tdai.models.description": "每个身份暴露的模型 ID。按需添加或移除行。",
  "settings.tdai.model.placeholder": "model-id",
  "settings.tdai.model.add": "添加模型",
  "settings.tdai.section.identities": "身份",
  "settings.tdai.identities.empty": "尚未配置身份。添加一个开始使用。",
  "settings.tdai.identity.add": "添加身份",
  "settings.tdai.identity.namePlaceholder": "显示名称",
  "settings.tdai.identity.headers": "身份请求头",
  "settings.tdai.identity.headersDescription": "逐字注入该身份每次请求的键值对。",
  ...
  // SSH Deploy
  "ssh.deploy.title": "添加 SSH 服务器",
  "ssh.deploy.host": "主机地址",
  "ssh.deploy.port": "端口",
  "ssh.deploy.username": "用户名",
  "ssh.deploy.password": "密码",
  "ssh.deploy.usernamePlaceholder": "root",
  "ssh.deploy.passwordPlaceholder": "可选",
  "ssh.deploy.output": "终端输出",
  "ssh.deploy.connectAndDeploy": "连接并部署",
  "ssh.deploy.deploying": "部署中...",
  "ssh.deploy.connecting": "正在连接服务器...",
  "ssh.deploy.connected": "连接成功",
  "ssh.deploy.connectedTo": "已连接到",
  "ssh.deploy.complete": "部署完成！",
  "ssh.deploy.terminalReady": "准备就绪。点击「连接并部署」开始。",
  "ssh.deploy.step.detectingOS": "正在检测操作系统...",
  "ssh.deploy.step.installingNodejs": "正在安装 Node.js...",
  "ssh.deploy.step.installingLoongcode": "正在安装 LoongCode...",
  "ssh.deploy.step.installingAgentmemory": "正在安装 agentmemory...",
  "ssh.deploy.step.startingServe": "正在启动 LoongCode 服务...",
  "ssh.deploy.button.add": "添加 SSH 服务器",

  // Desktop app menu
  "desktopMenu.app.checkForUpdates": "检查更新…",
  "desktopMenu.app.settings": "设置",
  "desktopMenu.app.reloadWebview": "重新加载页面",
  "desktopMenu.app.restart": "重启",
  "desktopMenu.app.exportLogs": "导出日志…",
  "desktopMenu.file": "文件",
  "desktopMenu.file.newSession": "新建会话",
  "desktopMenu.file.openProject": "打开项目…",
  "desktopMenu.file.settings": "设置",
  "desktopMenu.file.newWindow": "新建窗口",
  "desktopMenu.file.closeWindow": "关闭窗口",
  "desktopMenu.edit": "编辑",
  "desktopMenu.edit.undo": "撤销",
  "desktopMenu.edit.redo": "重做",
  "desktopMenu.edit.cut": "剪切",
  "desktopMenu.edit.copy": "复制",
  "desktopMenu.edit.paste": "粘贴",
  "desktopMenu.edit.delete": "删除",
  "desktopMenu.edit.selectAll": "全选",
  "desktopMenu.view": "视图",
  "desktopMenu.view.toggleSidebar": "切换侧边栏",
  "desktopMenu.view.toggleTerminal": "切换终端",
  "desktopMenu.view.toggleFileTree": "切换文件树",
  "desktopMenu.view.reload": "重新加载",
  "desktopMenu.view.toggleDevTools": "切换开发者工具",
  "desktopMenu.view.actualSize": "实际大小",
  "desktopMenu.view.zoomIn": "放大",
  "desktopMenu.view.zoomOut": "缩小",
  "desktopMenu.view.toggleFullScreen": "切换全屏",
  "desktopMenu.go": "转到",
  "desktopMenu.go.back": "后退",
  "desktopMenu.go.forward": "前进",
  "desktopMenu.go.previousSession": "上一个会话",
  "desktopMenu.go.nextSession": "下一个会话",
  "desktopMenu.go.previousProject": "上一个项目",
  "desktopMenu.go.nextProject": "下一个项目",
  "desktopMenu.window": "窗口",
  "desktopMenu.window.minimize": "最小化",
  "desktopMenu.window.maximize": "最大化",
  "desktopMenu.window.closeWindow": "关闭窗口",
  "desktopMenu.help": "帮助",
  "desktopMenu.help.documentation": "Loongcode 文档",
  "desktopMenu.help.supportForum": "支持论坛",
  "desktopMenu.help.exportLogs": "导出日志…",
  "desktopMenu.help.shareFeedback": "分享反馈",
  "desktopMenu.help.reportBug": "报告问题",
