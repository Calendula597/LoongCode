export const dict = {
  ...
  "command.skill.marketplace": "Маркетплейс скиллов",
  ...
  "settings.skills.tab.marketplace": "Магазин",

  "settings.skills.tab.installed": "Установленные",

  "settings.skills.tab.repos": "Репозитории навыков",
  ...
  "settings.skills.skillhub.enabled": "Включено",
