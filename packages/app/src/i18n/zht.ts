...
export const dict = {
  ...
  "command.skill.marketplace": "技能市場",
  ...
  "settings.skills.tab.marketplace": "技能市場",

  "settings.skills.tab.installed": "已安裝",

  "settings.skills.tab.repos": "技能倉庫",
  "settings.skills.install": "安裝",
  "settings.skills.uninstall": "卸載",
  "settings.skills.installed": "已安裝",
  "settings.skills.installing": "安裝中…",
  "settings.skills.uninstalling": "卸載中…",
  "settings.skills.mine": "我的",
  "settings.skills.searchPlaceholder": "搜尋技能…",
  "settings.skills.searchAria": "搜尋技能",
  "settings.skills.loading": "正在載入技能…",
  "settings.skills.empty": "未找到技能。",
  "settings.skills.noInstalled": "尚無已安裝技能。",
  "settings.skills.addRepo": "新增",
  "settings.skills.addingRepo": "正在新增…",
  "settings.skills.repoPlaceholder": "https://gitee.com/owner/repo",
  "settings.skills.repoAria": "新增 GitHub 倉庫",
  "settings.skills.noRepos": "尚未設定 GitHub 倉庫。",
  "settings.skills.error.install": "安裝「{name}」失敗",
  "settings.skills.error.uninstall": "卸載「{name}」失敗",
  "settings.skills.error.addRepo": "新增倉庫失敗",
  "settings.skills.removeRepo": "移除 {name}",
  "settings.skills.skillhub.pinnedName": "龍崗數據 Skill Hub",
  "settings.skills.skillhub.configured": "已連線",
  "settings.skills.skillhub.notConfigured": "未設定 API Key",
  "settings.skills.skillhub.enabled": "已啟用",
  "settings.skills.skillhub.configure": "配置 API 金鑰",
  "settings.skills.skillhub.disconnect": "斷開連接",
  "settings.skills.skillhub.dialog.title": "Skill Hub API 金鑰",
  "settings.skills.skillhub.dialog.description": "輸入 Skill Hub API 金鑰以存取私有技能。公開技能無需金鑰。",
  "settings.skills.skillhub.dialog.label": "API 金鑰",
  "settings.skills.skillhub.dialog.placeholder": "sk_...",
  "settings.skills.skillhub.dialog.save": "儲存",
  "settings.skills.skillhub.dialog.cancel": "取消",
  "settings.skills.skillhub.dialog.required": "請輸入 API 金鑰",
  "settings.skills.skillhub.dialog.invalid": "Skill Hub 拒絕了該 API 金鑰",
  "settings.skills.skillhub.dialog.error": "儲存 API 金鑰失敗",
  ...
  "settings.tdai.description": "設定 TDAI MemoryProxy 身份。每個身份共用同一連線，但傳送各自的請求標頭。",
  "settings.tdai.section.connection": "連線",
  "settings.tdai.url.title": "基礎 URL",
  "settings.tdai.url.description": "所有身份共用的 TDAI MemoryProxy 端點。",
  "settings.tdai.url.placeholder": "https://tdai.example.com/v1",
  "settings.tdai.apiKey.title": "API 金鑰",
  "settings.tdai.apiKey.description": "用於向 MemoryProxy 認證的 API 金鑰。",
  "settings.tdai.apiKey.placeholder": "sk-...",
  "settings.tdai.models.title": "模型",
  "settings.tdai.models.description": "每個身份暴露的模型 ID。按需新增或移除行。",
  "settings.tdai.model.placeholder": "model-id",
  "settings.tdai.model.add": "新增模型",
