...
import { DialogSSHServer } from "./dialog-ssh-server"
    ...
    <>
      ...
      >
        <div class="settings-v2-tab-header-row">
          ...
          <ButtonV2 variant="ghost-muted" icon="server" onClick={openAddSSH}>
            {language.t("ssh.deploy.button.add")}
          </ButtonV2>
          <WslAddServerButton />
        </div>
